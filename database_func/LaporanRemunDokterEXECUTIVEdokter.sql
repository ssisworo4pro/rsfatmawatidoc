-- CREATE DEFINER=`rsflaporan`@`%` PROCEDURE `rsfPelaporan`.`LaporanRemunDokterEXECUTIVEdokter`(
-- CREATE DEFINER=`root`@`localhost` PROCEDURE `rsfPelaporan`.`LaporanRemunDokterEXECUTIVEdokter`(
-- CREATE PROCEDURE rsfPelaporan.LaporanRemunDokterEXECUTIVEdokter(
DROP PROCEDURE IF EXISTS rsfPelaporan.LaporanRemunDokterEXECUTIVEdokter;
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `rsfPelaporan`.`LaporanRemunDokterEXECUTIVEdokter`(
	IN `TGLAWAL` DATETIME, 
...
BEGIN
	/* --------------------------------------------------------------------------------------------------------------- */
	/* -- rsfPelaporan.LaporanRemunDokterEXECUTIVEdokter															-- */
	/* --------------------------------------------------------------------------------------------------------------- */
	...
	-- call rsfPelaporan.LaporanRemunDokterEXECUTIVEdokter('2023-09-11','2023-09-11','0','0',864);
