DROP PROCEDURE IF EXISTS rsfPelaporan.orderlabTerimaUTD;
DELIMITER //
CREATE PROCEDURE rsfPelaporan.orderlabTerimaUTD(
	aOBJ VARCHAR(32) CHARSET utf8mb4,
	aKODE VARCHAR(35) CHARSET utf8mb4
)
BEGIN
	/* --------------------------------------------------------------------------------------------------------------- */
	/* -- rsfPelaporan.orderlabTerima 																				-- */
	/* -- description   : insert rsfMaster.tkatalog_ ....															-- */
	/* -- spesification : 																							-- */
	/* -- sysdateLast 	: 2023-07-31 13:00 																			-- */
	/* -- useridLast  	: ss 																						-- */
	/* -- revisionCount : 1 																						-- */
