salah token :
=========================
Result : {"errstat":"99999","errmsg":"network ok, 401 Unauthorized","rowno":0,"data":[]}
DATA : {"resourceType": "Condition", "clinicalStatus": {"coding": [{"system": "http://terminology.hl7.org/CodeSystem/condition-clinical","code": "active","display": "Active"}]}, "category": [{"coding": [{"system": "http://terminology.hl7.org/CodeSystem/condition-category","code": "encounter-diagnosis","display": "Encounter Diagnosis"}]}], "code": {"coding": [{"system": "http://hl7.org/fhir/sid/icd-10","code": "Q99.1","display": "46,XX true hermaphrodite"}]}, "subject": {"reference": "Patient/P01654557057","display": "Pasien 5"}, "encounter": {"reference": "Encounter/604b6add-97ea-4c44-a931-44fb451a7a29","display": "Kunjungan Pasien 5 di hari Senin, 5 December 2022"}}
AUTENTIKASI BERHASIL : VMg3ybIamDij8VzypQyG9zS5xlVBxxxx
onPROGRES : "SATUSEHAT Condition, 'Pasien 5 icd-10 46,XX true hermaphrodite (Q99.1)' on progress ..."
REQUEST : "SATUSEHAT Condition, 'Pasien 5 icd-10 46,XX true hermaphrodite (Q99.1)' on progress ..."

   
bener token :
=========================
Result : {"errstat":"99999","errmsg":"network ok, 400 Bad Request","rowno":0,"data":[]}
DATA : {"resourceType": "Condition", "clinicalStatus": {"coding": [{"system": "http://terminology.hl7.org/CodeSystem/condition-clinical","code": "active","display": "Active"}]}, "category": [{"coding": [{"system": "http://terminology.hl7.org/CodeSystem/condition-category","code": "encounter-diagnosis","display": "Encounter Diagnosis"}]}], "code": {"coding": [{"system": "http://hl7.org/fhir/sid/icd-10","code": "Q99.1","display": "46,XX true hermaphrodite"}]}, "subject": {"reference": "Patient/P01654557057","display": "Pasien 5"}, "encounter": {"reference": "Encounter/604b6add-97ea-4c44-a931-44fb451a7a29","display": "Kunjungan Pasien 5 di hari Senin, 5 December 2022"}}
   
AUTENTIKASI : [{"refresh_token_expires_in":"0","api_product_list":"[api-dev]","api_product_list_json":["api-dev"],"organization_name":"ihs-prod-1","developer.email":"amar.griffindor@gmail.com","token_type":"BearerToken","issued_at":"1670993949312","client_id":"V0zwrxqxuTMSiYGydjay72xa2biuLyy5JcLIc6jGUiorS08e","access_token":"iX92Nv0GUfGATAakDHSWDlrgFypO","application_name":"0c54466b-c699-4e8b-904d-ed70f5e59a1c","scope":"","expires_in":"3599","refresh_count":"0","status":"approved"}]


http://192.168.5.52:90/interconn?parm0=satusehatSet&parm1=Location&parm2={"address":{"city":"Jakarta","country":"ID","extension":[{"extension":[{"url":"province","valueCode":"31"},{"url":"city","valueCode":"3171"},{"url":"district","valueCode":"317101"},{"url":"village","valueCode":"31710101"},{"url":"rt","valueCode":"000"},{"url":"rw","valueCode":"000"}],"url":"https://fhir.kemkes.go.id/r4/StructureDefinition/administrativeCode"}],"line":["Gedung Laboratorium RSUP Fatmawati Jalan Fatmawati Cilandak"],"postalCode":"12430","use":"work"},"description":"Lab Induk ","id":"1994ac97-bd82-4914-a968-fa3a1ce13880","identifier":[{"system":"http://sys-ids.kemkes.go.id/location/1000001","value":"101070101"}],"managingOrganization":{"reference":"Organization/10080037"},"meta":{"lastUpdated":"2022-12-15T03:09:12.232772+00:00","versionId":"MTY3MTA3Mzc1MjIzMjc3MjAwMA"},"mode":"instance","name":"Lab Induk ","physicalType":{"coding":[{"code":"ro","display":"Room","system":"http://terminology.hl7.org/CodeSystem/location-physical-type"}]},"position":{"altitude":0,"latitude":106.83239885393944,"longitude":-6.23115426275766},"resourceType":"Location","status":"active","telecom":[{"system":"phone","use":"work","value":"0000"},{"system":"fax","use":"work","value":"0000"},{"system":"email","value":"0000"},{"system":"url","use":"work","value":"0000"}]}&parm3=1
...
select		1 as id_organization,		
			...
			jenis_kunjungan as ruangan_kunjungan,
			deskripsi as ruangan_deskripsi,
			concat('', deskripsi) as loc_nama,
			concat('', deskripsi, '') as loc_deskripsi,
			concat('Gedung Laboratorium RSUP Fatmawati') as loc_alamat,
			'0000' as loc_telp,
			'0000' as loc_fax,
			'0000' as loc_email,
			'0000' as loc_url,
			...
			0 as response_stat
	from 	master.ruangan 
	where 	SUBSTR(id,1,7) = '1010701' and JENIS_KUNJUNGAN = 4 AND JENIS = 5; 	
...
select		1 as id_organization,		
			...
			concat('', deskripsi) as loc_nama,
			concat('', deskripsi, '') as loc_deskripsi,
			concat('Gedung Farmasi RSUP Fatmawati') as loc_alamat,
			'0000' as loc_telp,
			'0000' as loc_fax,
			'0000' as loc_email,
			'0000' as loc_url,
			...
			0 as response_stat
	from 	master.ruangan 
	where 	SUBSTR(id,1,7) = '1010301' and JENIS_KUNJUNGAN = 11 AND JENIS = 5; 
...
insert into rsfInterconn.satusehat_morganization
	( 	id,		kode,	nama,	telpon,		email,		url,	
		...
		alamat_kd_negara,	alamat_kd_kelurahan, alamat_rt, alamat_rw,
		sysdate_in, sysdate_last, response_stat)
	values 
	(	1, '10080037', 'RSUP Fatmawati', '+6221-7501524', 'humas@fatmawatihospital.com',
		...
		'31710101', '000', '000', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
